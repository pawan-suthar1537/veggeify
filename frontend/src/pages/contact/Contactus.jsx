...
const Contactus = () => {
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        <div>
            <p className="font-medium text-center text-6xl lg:text-6xl my-10 ">Contact us</p>
            ...
            <div className="p-4 py-6 rounded-lg  md:p-8">
                <form>
                    ...
                    <div className="w-full mt-4">
                        ...
                        <textarea className="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg md:h-56 dark:placeholder-gray-600  dark:text-gray-300  focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                    </div>
